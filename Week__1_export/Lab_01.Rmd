...
```{r linewidth=80}
append(append(rev(x)[[1]],y),rev(x[1:2]))
```
...
```{r linewidth=80}
mw = matrix(c('Kyle','Wagner','Peter','Freeman'),nrow=2)
mw
```
